      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
          ...
          <div class="form-group">
            ...
            <select multiple name="mata_kuliah" id="mata_kuliah" class="form-control" size="7" required>
              ...
              <option value="Matematika I">Matematika I</option>
              <option value="Analisis dan Desain Perangkat Lunak">Analisis dan Desain Perangkat Lunak</option>
            </select>
          </div>
